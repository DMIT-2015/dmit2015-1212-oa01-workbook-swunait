...
public class ApplicationStartupListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        if (callerUserRepository.list().size() == 0) {
            ...
            CallerUser it01 = new CallerUser();
            it01.setUsername("it01");
            callerUserRepository.add(it01, "Password2015", new String[]{"IT"});
            ...
            CallerUser salesit01 = new CallerUser();
            salesit01.setUsername("salesit01");
            callerUserRepository.add(salesit01, "Password2015", new String[]{"Sales","IT"});
        } else {
